...
<template>
  <div>
    ...
    <el-table size="small" @selection-change="selectChange" :data="userData" highlight-current-row v-loading="loading" border element-loading-text="拼命加载中" style="width: 100%;">
      ...
      <el-table-column align="center" sortable prop="account" label="用户名" width="120">
      </el-table-column>
      ...
      <el-table-column align="center" sortable prop="status" label="状态" min-width="50">
        <template slot-scope="scope">
          <el-switch v-model="scope.row.status =='y'?nshow:fshow" active-color="#13ce66" inactive-color="#ff4949"
    ...
    <el-dialog :title="title" :visible.sync="editFormVisible" width="30%" @click='closeDialog("edit")'>
      <el-form label-width="80px" ref="editForm" :model="editForm" :rules="rules">
        ...
        <el-form-item label="状态" prop="status">
          <el-radio v-model="editForm.status" label="y">启动</el-radio>
          <el-radio v-model="editForm.status" label="n">禁用</el-radio>
        </el-form-item>
      </el-form>
